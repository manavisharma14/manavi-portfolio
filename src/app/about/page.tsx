...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "AI accessibility platform for diagnosing and improving color vision.",
    details: {
      problem: "Millions of people live with color vision deficiency, yet most tools only simulate what they're missing — they don't help.",
      solution: "Built a computer-vision pipeline using OpenCV and TensorFlow to detect CVD severity from a webcam test, then apply real-time color correction overlays tailored to each user's specific deficiency profile.",
      outcome: "Accepted into NSF i-Corps and Chicago Booth's accelerator. Ran a clinical study validating accuracy. Platform now in early access at beyondcolor.app.",
      role: "Solo founder — research, ML model, full-stack app, clinical study design.",
    },
  },
  {
    title: "HabitCheck",
    ...
    <main onMouseMove={handleMouseMove}>
        ...
        <div className="hero-inner">
          ...
          <div className="hero-left">
            ...
            <div className="cta">
              ...
              <button className="btn-secondary">download résumé</button>
            </div>
          </div>
          ...
          <div className="contact-left">
            ...
            <div className="contact-links">
              <a href="mailto:manavisharma14@gmail.com" className="contact-link">
                <span className="link-icon">✉</span> manavisharma14@gmail.com
              </a>
              <a href="https://github.com/manavisharma14" target="_blank" rel="noopener noreferrer" className="contact-link">
                <span className="link-icon">⌥</span> github.com/manavisharma14
              </a>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .canvas { position: relative; width: 540px; height: 520px; }
        .sticky {
          position: absolute;
          width: 138px;
          padding: 12px 13px;
        ...
        .skill-num { font-size: 11px; font-weight: 600; color: #e0ddd6; }
        .skill-card-divider { height: 1px; background: #f5f3ef; }
        .skill-items-list { display: flex; flex-direction: column; }
        .skill-item {
          font-size: 13px;
          font-weight: 500;
          color: #444;
